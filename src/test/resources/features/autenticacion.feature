Feature: Autenticacion en formulario de Colorlib
  ...
  Scenario: Diligenciamiento exitoso del formulario de autenticacion en Colorlib 1
  ...
  Scenario: Diligenciamiento exitoso del formulario de autenticacion en Colorlib 2
    Given Yo Ingreso a la plataforma colorlib
  ...
  Scenario Outline: Diligenciamiento exitoso del formulario de autenticacion en Colorlib 3
    Given Yo Ingreso a la plataforma colorlib
    When Yo me autentico con los siguientes datos con titulos
      | <Usuario> | <Clave> |
    Then Yo verifico el ingreso exitoso
  ...
  Scenario Outline: Diligenciamiento exitoso del formulario de autenticacion en Colorlib 4
    Given Yo Ingreso a la plataforma colorlib
    When Yo me autentico con los siguientes datos con titulos
      | <Usuario> | <Clave> |
    ...
    Examples:
      ...
      | demo3    | demo3  | Bootstrap-Admin-Template |

  @AutenticacionExitosaConDatosExcel
  Scenario Outline: Diligenciamiento exitoso del formulario de autenticacion en Colorlib 5
    Given Yo Ingreso a la plataforma colorlib
    ...
    Examples:
      | Usuario  | Clave  | Esperado                 |
      ##@externaldata@./src/test/resources/datos/datos.xlsx@Hoja1
   |demo1   |demo1   |Bootstrap-Admin-Template|
   |demo2   |demo2   |Bootstrap-Admin-Template|
   |demo3   |demo3   |Bootstrap-Admin-Template|
  ...
  @AutenticacionExitosaConModeloDeDatos
  Scenario Outline: Diligenciamiento exitoso del formulario de autenticacion en Colorlib 6
    Given Yo Ingreso a la plataforma colorlib
    ...
    Examples:
      | usuario  | clave  | esperado                 |
      ##@externaldata@./src/test/resources/datos/datosModelo.xlsx@Hoja1
   |demo1   |demo1   |Bootstrap-Admin-Template|
   |demo2   |demo2   |Bootstrap-Admin-Template|
   |demo3   |demo3   |Bootstrap-Admin-Template|
  ...
  Scenario: Validar password valido
    Given Yo Ingreso a la plataforma colorlib
    And Yo ingreso el usuario
    And Yo ingreso la clave valida
    When Yo presiono el boton de ingresar
